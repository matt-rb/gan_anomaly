...
dataset_root='/home/moin/GitHub/AbnormalityGAN/data/UCSD/frm/UCSDped2/Train/';
of_root='/home/moin/GitHub/AbnormalityGAN/data/UCSD/of/Ped2/Train/';
% output roots. all video frames will put toghether to collect data for train
dataset_out_root='/home/moin/GitHub/AbnormalityGAN/data/UCSD/train_data/Ped2/frm/';
of_out_root='/home/moin/GitHub/AbnormalityGAN/data/UCSD/train_data/Ped2/of/';
gan_ab_out_root='/home/moin/GitHub/AbnormalityGAN/data/UCSD/train_data/train_data_gan_ped2_of/';
...
for i=1:length(dataset_folder)
    ...
    for j=1:length(frm_lst)
        ...
        %of_l = of_l(:,:,3);
        im_l_name = sprintf('%s%04d.jpg', [dataset_out_root 'train/'], sample_counter);
        of_l_name = sprintf('%s%04d.jpg', [of_out_root 'train/'], sample_counter);
...
%% python script for creating GAN training data foramt
...
%% train command
disp(sprintf('to train GAN run :\nDATA_ROOT=%s name=%s which_direction=BtoA niter=10 flip=0 save_epoch_freq=1 which_model_netG=encoder_decoder th train.lu', gan_ab_out_root,'mag_generation'));
% DATA_ROOT=../data/UCSD/train_data/train_data_gan name=mag_generation niter=10 save_epoch_freq=1 which_direction=BtoA which_model_netG=encoder_decoder flip=0 th train.lua